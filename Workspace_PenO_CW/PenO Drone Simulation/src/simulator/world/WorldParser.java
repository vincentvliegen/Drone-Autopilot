...
public class WorldParser extends World {
	...
	private void checkWindChange() {
		 ...
		 * getCurrentTime()); System.out.println("WindSpeedX: " +
		 * getWindSpeedX()); System.out.println("WindSpeedY: " +
		 * getWindSpeedY()); System.out.println("WindSpeedZ: " +
		 * getWindSpeedZ()); System.out.println("WindRotationX: " +
		 * getWindRotationX()); System.out.println("WindRotationY: " +
		 * getWindRotationY()); System.out.println("WindRotationZ: " +
		 * getWindRotationZ()); System.out.println("---------");
		 */
	...
	public void display(GLAutoDrawable drawable) {
		...
		if (crash) {
			 ...
			 * zijn? Dan moeten er voor elke drone (manueel) 2 buffers
			 * aangemaakt worden (een voor linker en een voor rechter camera);
			 * dus vermijden..! --> idee: ipv telkens een nieuwe int[] te maken,
			 * gewoon een grotere te gebruiken en de offset aan te passen?
			 */
