...
public class HourglassPolyhedron extends PredefinedPolyhedron {
	...
	//upperhalf
	static double[] point1 = { -0.5, 0.5, -0.5 };
	static double[] point2 = { -0.5, 0.5, 0.5 };
	static double[] point3 = { 0, 0, 0 };
	static double[] point4 = { 0.5, 0.5, -0.5};
	static double[] point5 = { 0.5, 0.5, 0.5};
	static double[] point6 = { -0.5, -0.5, -0.5};
	static double[] point7 = { -0.5, -0.5, 0.5};
	static double[] point8 = { 0.5, -0.5, 0.5};
	static double[] point9 = { 0.5, -0.5, -0.5};
