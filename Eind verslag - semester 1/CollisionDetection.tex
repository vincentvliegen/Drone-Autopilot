Twee objecten A en B botsen met elkaar indien de afstand tussen hun zwaartepuntcentra kleiner is dan de som van hun twee radii. Dit wordt gecontroleerd met behulp van de volgende formule:
\begin{equation*}
